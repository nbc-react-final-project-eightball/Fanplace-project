...
const CustomSelect: React.FC<CustomSelectProps> = ({ scrollPostion }) => {
      ...
      element: (
        ...
        >
          ...
          <path
            ...
            style={{
              fill: scrollPostion < 150 ? '#585858' : '#fff',
              stroke: scrollPostion < 150 ? '#585858' : '#fff',
            }}
            stroke-width="1.6"
            stroke-linejoin="round"
          />
      ...
      <S.SelectHeader onClick={toggleMenu}>
        ...
        >
          <path
            ...
            style={{ fill: scrollPostion < 150 ? '#585858' : '#fff' }}
          />
        </svg>
      </S.SelectHeader>
      {isOpen && (
